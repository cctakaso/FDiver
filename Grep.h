...
public:
	...
	// 一つの検索ﾊﾟﾀｰﾝによる下準備をする。
	virtual BOOL InitPattern(CGrepPattern  *pGrepPattern, BOOL fStripWild_left=TRUE, BOOL fStripWild_right=TRUE)=0;
...
public:	
	...
	// 一つの検索ﾊﾟﾀｰﾝによる下準備をする。
	BOOL InitPattern(CGrepPattern  *pGrepPattern, BOOL fStripWild_left=TRUE, BOOL fStripWild_right=TRUE);
